                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Soal 6: Kritis Berpikir dan Literasi Digital',
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                        ...
                        SizedBox(height: 10),
                        Text(
                          'Jelaskan bagaimana keterampilan berpikir kritis membantu seseorang dalam mempraktikkan literasi digital yang baik.',
                          style: TextStyle(
                            fontSize: 16,
