...
class Tugas2Page extends StatefulWidget {
  @override
  _Tugas2PageState createState() => _Tugas2PageState();
}
...
class _Tugas2PageState extends State<Tugas2Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Tugas 2 - Hubungan AI dengan Literasi Digital',
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Soal 2: Hubungan AI dengan Literasi Digital',
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                        ...
                        SizedBox(height: 10),
                        Text(
                          'Bagaimana literasi digital dan AI dapat saling melengkapi dalam meningkatkan mutu pendidikan?',
                          style: TextStyle(
                            fontSize: 16,
