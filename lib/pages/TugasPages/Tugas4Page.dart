...
class Tugas4Page extends StatefulWidget {
  @override
  _Tugas4PageState createState() => _Tugas4PageState();
}
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Soal 4: Pengantar Literasi Digital',
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                        ...
                        SizedBox(height: 10),
                        Text(
                          'Jelaskan bagaimana literasi digital dapat membantu Anda dalam kehidupan sehari-hari.',
                          style: TextStyle(
                            fontSize: 16,
