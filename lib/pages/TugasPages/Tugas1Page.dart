...
class Tugas1Page extends StatefulWidget {
  @override
  _Tugas1PageState createState() => _Tugas1PageState();
}
...
class _Tugas1PageState extends State<Tugas1Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Tugas 1 - Pengenalan Literasi Digital',
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Soal 1: Definisi Literasi Digital',
                          style: TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                        ...
                        SizedBox(height: 10),
                        Text(
                          'Jelaskan mengapa literasi digital penting di era digital saat ini!',
                          style: TextStyle(
                            fontSize: 16,
